...
export default function Courses() {
  ...
  const calculateProgress = (course) => {
      ...
      const studiedSets = courseSets.filter(set =>
          sessions.some(session => session.setId === set.id)
      ).length;
                                          ...
                                          >
                                              <div className="flex w-full items-center space-x-4 grow">
                                                  ...
                                                  <div className="text-gray-500 pr-2">
                                                      ...
                                                      {studiedSets === totalSets && totalSets > 0 ? (
                                                          <svg
                                                  ...
                                                  <div className="flex flex-col w-full">
                                                      <div className="flex flex-col grow">
                                                          ...
                                                          <span className="text-sm text-gray-500">
                                                              {studiedSets} of {totalSets} sets studied
                                                          </span>
                                                          ...
                                                          <div className="w-3/4 bg-gray-200 rounded-full h-2.5 mt-3">
                                                              <div
                                                                  ...
                                                                  style={{
                                                                      ...
                                                                      backgroundColor: progressPercentage === 100 ? 'green' : '#6b46c1',
                                                                  }}
                                                              ></div>
                                                          </div>
                                                      </div>
